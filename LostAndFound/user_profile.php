...
// Include sidebar navigation (SEBELUM DOCTYPE)
            ...
            <div class="profile-left">
                ...
                <div class="profile-card">
                    ...
                    <div class="info-item" style="border-left-color: #f39c12;">
                        <div class="info-label">
                            <i class="fas fa-key"></i> USER KEY
                        </div>
                        <div class="info-value key"><?php echo $user_key; ?></div>
                    </div>
                ...
                <div class="form-card">
                    ...
                    <div style="margin-top: 30px; padding: 20px; background: #f0f9ff; border-radius: 12px; border-left: 4px solid #3498db;">
                        ...
                        <ul style="color: #4a5568; font-size: 14px; line-height: 1.8; padding-left: 20px;">
                            <li>Your USER KEY is unique - keep it safe</li>
                            <li>Current password is shown for reference</li>
                            <li>Enter new password only if you want to change it</li>
                            <li>Profile picture will be resized automatically</li>
                            <li>Contact number helps admin reach you</li>
                        </ul>
                    </div>
                </div>
            </div>
