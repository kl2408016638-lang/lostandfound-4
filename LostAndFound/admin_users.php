...
if(isset($_POST['edit_user'])) {
    ...
    if(!isset($email_error)) {
        ...
        if(mysqli_query($connect, $update_sql)) {
            ...
            $log_desc = "Edited {$user_role} account #{$user_id_to_edit} from '{$old_name}' to '{$new_name}'";
...
// Include admin sidebar - SEBELUM DOCTYPE
...
<head>
    ...
    <style>
        * {
        ...
        /* CONTENT STYLING UNTUK DALAM admin-main-content */
        .users-wrapper {
            max-width: 1400px;
            margin: 0 auto;
            padding: 20px;
