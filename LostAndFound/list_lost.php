...
if(isset($_POST['update_status'])) {
    ...
    $get_old_sql = "SELECT status, type_item FROM items WHERE id = '$item_id' AND item_type = 'lost'";
    ...
    // Validate: Lost items can only have matched or claimed status (from pending)
    $allowed_statuses = ['matched', 'claimed']; // Lost items skip 'approved'
    if(in_array($new_status, $allowed_statuses)) {
        ...
        if(mysqli_query($connect, $update_sql)) {
            ...
            logAdminAction($connect, $user_id, $user_name, 'update_status', 'lost_item', $item_id, $item_name, "Updated lost item #{$item_id} status from {$old_status} to {$new_status}");
        } else {
...
// Query to get LOST items only
$where_clause = "item_type = 'lost'";
if(!empty($search)) {
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <div class="stats-badge">
                    ...
                    Total Lost Items: <?php echo $total_items; ?>
                </div>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <!-- PICTURE COLUMN - INI YANG AWAK TAK ADA! -->
                                <td>
                                ...
                                <!-- ADMIN: Change Status Form for LOST items -->
                                <td>
            ...
            <?php else: ?>
                <div class="no-items">
                    ...
                    <h3 style="color: #7f8c8d; margin-bottom: 10px;">
                        <?php if(!empty($search)): ?>
                            No lost items matching "<?php echo htmlspecialchars($search); ?>"
                        <?php else: ?>
                            No lost items have been reported yet.
                        <?php endif; ?>
                    </h3>
                    <p style="color: #95a5a6; font-size: 14px;">
                        Users can report lost items through the report form.
                    </p>
                </div>
            <?php endif; ?>
