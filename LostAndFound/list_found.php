...
if($user_role == 'admin' && isset($_POST['update_status'])) {
    ...
    $get_old_sql = "SELECT status, type_item, item_type FROM items WHERE id = '$item_id'";
    ...
    if(in_array($new_status, $allowed_statuses)) {
        ...
        if(mysqli_query($connect, $update_sql)) {
            ...
            logAdminAction($connect, $user_id, $user_name, 'update_status', 'found_item', $item_id, $item_name, "Updated found item #{$item_id} status from {$old_status} to {$new_status}");
        } else {
...
// Query to get FOUND items only
$where_clause = "item_type = 'found'";
if(!empty($search)) {
        ...
        <div class="main-content">
            ...
            <div class="info-box">
                ...
                <p style="color: #666; line-height: 1.6; font-size: 14px;">
                    <?php if($user_role == 'admin'): ?>
                        • <strong>Status Flow for Found Items:</strong> Pending → Approved → Matched → Claimed → Closed<br>
                    ...
                    <?php else: ?>
                        ...
                        &nbsp;&nbsp;- <span class="status-badge status-closed" style="font-size: 10px;">Closed</span>: Case is completed
                    <?php endif; ?>
                </p>
            </div>
