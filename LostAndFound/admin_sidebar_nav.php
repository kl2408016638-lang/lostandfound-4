    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function setActiveMenu() {
                ...
                // Check jika current page ada dalam submenu
                const submenuItems = {
            ...
            // Event listeners untuk submenu toggle
...
<body>
    ...
    <div class="admin-top-header">
        ...
        <div class="admin-header-right">
            ...
            <div class="admin-dropdown">
                <!-- Dalam admin-user-profile section -->
    <div class="admin-user-profile">
    <div class="admin-user-avatar" style="background: none; border: none;">
        <?php
        // Display profile picture
        $profile_pic = $_SESSION['profile_pic'] ?? 'avatar_default.png';
        $avatar_path = str_starts_with($profile_pic, 'avatar_') ? 
                      'images/avatars/' . $profile_pic : 
        ...
        <?php else: ?>
            <img src="images/avatars/avatar_default.png" 
                 alt="Profile" 
                 style="width: 100%; height: 100%; border-radius: 50%; object-fit: cover;">
        <?php endif; ?>
    </div>
